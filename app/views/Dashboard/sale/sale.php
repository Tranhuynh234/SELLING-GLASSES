...
<html lang="vi">
  <head>
    ...
    <link rel="stylesheet" href="../../../../public/assets/css/sale.css" />
    <link
  ...
  <body>
          ...
          <div class="toolbar-container">
            ...
            <div class="filter-group">
              ...
              <div class="filter-tabs">
                ...
                <button class="filter-tab" data-status="sap-co">
                  Sắp có hàng
                </button>
    ...
    <!-- FILE JS -->
    <script src="../../../../public/assets/js/sale.js"></script>
