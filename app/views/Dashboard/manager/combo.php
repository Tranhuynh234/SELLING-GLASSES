...
<div id="comboModal" class="modal-overlay" style="display: none;">
    <div class="modal-card">
        ...
        <div class="modal-head">
            ...
            <span class="close-modal" onclick="closeModalCombo()">&times;</span>
        </div>
        ...
        <form id="comboForm">
            ...
            <div class="modal-body">
                ...
                <div class="input-field">
                    <label>Mô tả</label>
                    <textarea id="comboDescription" placeholder="Mô tả chi tiết về combo..."
                        style="padding: 10px; border: 1px solid #ddd; border-radius: 4px; font-family: inherit; min-height: 80px;"></textarea>
                </div>
                ...
                <div class="input-field">
                    ...
                    <img id="imagePreview"
                        style="max-width: 200px; max-height: 200px; margin-top: 10px; border-radius: 4px; display: none;">
                </div>
                ...
                <div class="input-field">
                    ...
                    <div id="productList"
                        style="border: 1px solid #ddd; border-radius: 4px; max-height: 300px; overflow-y: auto; margin-top: 10px;">
                    </div>
                </div>
            ...
            <div class="modal-foot">
                <button type="button" class="btn-ghost" onclick="closeModalCombo()">
