                            ...
                            <div class="policy-content">
                                <ul>
                                    <li><strong>1. Bảo hành Gọng kính</strong>
                                        <ul>
                                            <li>Bảo hành 12 tháng đối với các lỗi kỹ thuật (mới hàn, ốc vít, lỏ xo) từ nhà sản xuất.</li>
                                        </ul>
                                    </li>
                                    <li><strong>2. Bảo hành Tròng kính</strong>
                                        <ul>
                                            <li>Bảo hành 06 tháng cho lớp vàng phủ (coating) nếu có hiện tượng bong trắc từ nhiên.</li>
                                        </ul>
                                    </li>
                                    <li><strong>3. Dịch vụ miễn phí trọn đời</strong>
                                        <ul>
                                            <li>Thay đệm mũi, vệ sinh kính bằng sóng siêu âm và năn chính form kính hoàn toàn miễn phí.</li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="policy-content">
                                <ul>
                                    <li><strong>1. Thời gian áp dụng</strong>
                                        <ul>
                                            <li>Khách hàng có quyền đổi trả sản phẩm trong vòng 07 ngày kể từ ngày nhận hàng.</li>
                                        </ul>
                                    </li>
                                    <li><strong>2. Điều kiện đổi trả</strong>
                                        <ul>
                                            ...
                                            <li>Sản phẩm không có dấu hiệu đã qua sử dụng hoặc bị tác động ngoại lực gây trầy xước sau khi nhận hàng.</li>
                                        </ul>
                                    </li>
                                    <li><strong>3. Quy trình thực hiện</strong>
                                        <ul>
                                            <li>Liên hệ Hotline 1900 1234 hoặc chọn "Hỗ trợ khách hàng" để được hướng dẫn gửi hàng về trung tâm bảo hành.</li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
