...
<head>
    ...
    <link rel="stylesheet" href="../../../public/assets/css/ops.css">
</head>
<body>
        ...
        <div class="app-container">
            <aside class="sidebar">
                ...
                <nav class="sidebar-menu">
                    ...
                    <a href="#" class="nav-link active" data-tab="dashboard"><i class="fa-solid fa-chart-pie"></i> Tổng quan</a>
                    <a href="#" class="nav-link" data-tab="orders"><i class="fa-solid fa-receipt"></i> Đơn hàng</a>
                    <a href="#" class="nav-link" data-tab="shipping"><i class="fa-solid fa-truck-fast"></i> Vận chuyển</a>
                    <div class="menu-label">HỆ THỐNG</div>
                    <a href="#" class="nav-link" data-tab="warehouse"><i class="fa-solid fa-boxes-stacked"></i> Quản lý kho</a>
            ...
            <main class="main-viewport">
                <header class="top-header">
                    <div class="header-search">
                        ...
                        <input type="text" id="global-search" placeholder="Tìm kiếm nhanh..." oninput="opsApp.handleGlobalSearch(this.value)">
                    </div>
    ...
    <script src="../../../public/assets/js/ops.js"></script>
</body>
</html>