    ...
    <div class="fixed top-0 left-0 w-full z-50 shadow-sm flex flex-col">
        <div class="bg-[#111] text-white text-[11px] py-2 px-6 flex justify-between items-center font-medium">
            ...
            <div id="auth-box" class="flex space-x-4">
                ...
                <span class="flex items-center gap-2 cursor-default">
                    <i class="fa-solid fa-user"></i> Xin chào,
        ...
        <header class="bg-white py-4 px-6 md:px-12 flex justify-between items-center border-b border-stone-100">
            <a href="/SELLING-GLASSES/public/home"
                class="font-bold text-3xl tracking-tighter hover:opacity-80 transition">
            ...
            <nav class="hidden lg:flex space-x-8 font-medium text-stone-600">
                ...
                <a href="/SELLING-GLASSES/public/home#khuyen-mai" class="hover:text-amber-700">Khuyến mãi</a>
            ...
            <div class="flex space-x-5 text-xl text-stone-700 items-center relative">
                ...
                <!-- Icon chat support -->
                <button id="btn-home-chat" onclick="openSupportChat()"
                    class="relative text-stone-700 hover:text-amber-700 transition">
                    <i class="fas fa-comment-dots"></i>
                    <span id="home-chat-badge"
                        class="absolute -top-2 -right-2 bg-amber-600 text-white text-[10px] w-4 h-4 rounded-full flex items-center justify-center"
